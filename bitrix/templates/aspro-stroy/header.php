...
window.onload = function(){
	var my = document.getElementById("bx_3218110189_197").innerHTML;
	var my2 = document.getElementById("bx_3218110189_196").innerHTML;
	document.getElementById("bx_3218110189_197").innerHTML = my2;
	document.getElementById("bx_3218110189_196").innerHTML = my;
}
